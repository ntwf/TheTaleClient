...
extension Notification.Name {
    ...
    static let TaleAPIAuthorisationStatusChanged        = NSNotification.Name("TaleAPIAuthorisationStatusChanged")
}
...
class TaleAPI: NSObject, NetworkClient {
    ...
    // MARK: Managers
    @objc var playerInformationManager: PlayerInformationManager
    var gameInformationManager: GameInformationManager
    @objc var diaryManager: DiaryManager
    ...
    enum UserInfoKey {
        ...
        static let authorisationStatus        = "TaleAPIAuthorisationStatus"
    }
