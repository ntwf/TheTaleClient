...
class PlayerInformationManager: NSObject {
    ...
    @objc dynamic var playerInformation         = PlayerInformation(jsonObject: [:])
    @objc dynamic var accountInformation        = AccountInformation(jsonObject: [:])
    @objc dynamic var turn                      = Turn(jsonObject: [:])
    @objc dynamic var hero                      = Hero(jsonObject: [:])
    @objc dynamic var journal: [JournalMessage] = []
    @objc dynamic var action                    = Action(jsonObject: [:])
    @objc dynamic var cardsInfo                 = CardsInfo(jsonObject: [:])
    @objc dynamic var equipment: [Artifact]     = []
    @objc dynamic var bag: [[Artifact: Int]]    = [[:]]
    @objc dynamic var companion                 = Companion(jsonObject: [:])
    @objc dynamic var energy                    = Energy(jsonObject: [:])
    @objc dynamic var heroBaseParameters        = HeroBaseParameters(jsonObject: [:])
    @objc dynamic var heroSecondaryParameters   = HeroSecondaryParameters(jsonObject: [:])
    @objc dynamic var heroPosition              = Position(jsonObject: [:])
    @objc dynamic var might                     = Might(jsonObject: [:])
    @objc dynamic var quests: [Quest]           = []
